...
public enum Field {
    ...
    SUBMITTER_AFFILIATION("submitter_affiliation", FieldType.OPTIONAL, FieldCategory.ADDITIONAL,
    ...
    ENRICH_PUBMED_ABSTRACT("pubmed_abstract_synonyms", FieldType.UNKNOWN, FieldCategory.ADDITIONAL,
            "Pubmed Abstract Synonyms"),
    ENRICHE_PUBMED_TITLE("pubmed_title_synonyms", FieldType.UNKNOWN, FieldCategory.ADDITIONAL,
    ...
    PTM_MODIFICATIONS("ptm_modification", FieldType.OPTIONAL, FieldCategory.ADDITIONAL,
    ...
    TECHNOLOGY_TYPE("technology_type", FieldType.OPTIONAL, FieldCategory.ADDITIONAL,
            "Additional Tags of the Technology"),
    PROTEOMEXCHANGE_TYPE_SUBMISSION("proteomexchange_type_submission", FieldType.OPTIONAL,
            FieldCategory.ADDITIONAL, "Complete or Partial Submission"),
